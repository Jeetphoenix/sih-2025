    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-purple-600 text-white">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-lg font-semibold">{t('visitorDashboard')}</h1>
          </div>
      ...
      <main className="max-w-6xl mx-auto px-4 py-6 space-y-6">
        ...
        <section className="bg-white rounded-xl shadow-sm p-4 border">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
            ...
            <div className="md:col-span-4">
              <button className="w-full px-4 py-3 rounded-lg bg-purple-700 text-white hover:bg-purple-800">{t('searchButton')}</button>
            </div>
          </div>
        </section>
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {filtered.map((farm) => (
            <div key={farm.id} className="bg-white rounded-xl shadow-sm border overflow-hidden">
              <div className="h-28 bg-gray-50 flex items-center justify-center text-gray-300"><MapPin className="h-8 w-8" /></div>
              <div className="p-4">
