      ...
      <header className="bg-purple-600 text-white">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-lg font-semibold">{t('recentVisits')}</h1>
          </div>
              ...
              <div key={v.id} className={`border rounded-lg overflow-hidden ${v.isRecent ? 'border-purple-300 bg-purple-50' : 'bg-gray-50'}`}>
                <div className="flex items-center justify-between p-4">
                  <div>
                    ...
                    <div className="text-xs text-gray-500">{t('visitedOn')} {v.date}</div>
                  </div>
                  <div className="text-right">
                    ...
                    <div className="text-xs text-gray-500 mt-1">{t('durationLabel')}: {v.duration}</div>
                  </div>
                </div>
